...
namespace Shopping.Web.Pages
{
    public class ProductListModel (ICatalogService catalogService, IBasketService basketService, ILogger<ProductListModel> logger)
        : PageModel
    {
        public IEnumerable<string> CategoryList { set; get; } = [];

        public IEnumerable<ProductModel> ProductList { set; get; } = [];
        ...
        {
            var response = await catalogService.GetProducts(new GetProductsRequest());
